...
export class sceneEcole extends Phaser.Scene
{
    constructor(){
        super('sceneEcole');
    ...
    preload(){
        ...
        this.load.image('tuile3', 'assets/tuiles_3.png');
        this.load.tilemapTiledJSON('carte3', 'assets/map_3.json');
        this.load.spritesheet('player','assets/eden.png',
            { frameWidth: 32, frameHeight: 32 });
    }
    create(){
        this.add.image(320,200,'ecole');
        ...
        this.player = this.physics.add.sprite(10, 325, 'player');
