import {sceneEcole} from './ecole.js';


export class sceneCroisement extends Phaser.Scene
{
    constructor(){
        super('sceneCroisement');
    }
    ...
    preload(){
        this.load.image('croisement','assets/croisement.png');
        ...
        this.load.image('tuile2', 'assets/tuiles_2.png');
        this.load.tilemapTiledJSON('carte2', 'assets/map_2.json');
        this.load.spritesheet('player','assets/eden.png',
            { frameWidth: 32, frameHeight: 32 });
    }
    create(){
        this.add.image(200,320 ,'croisement');
        ...
        this.player = this.physics.add.sprite(10, 550, 'player');
